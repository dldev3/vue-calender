    ...
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat color="white">
          <v-btn outlined class="mr-4" @click="dialog = true">New Event</v-btn>
  ...
  <v-card>
    <v-container>
      <v-form @submit.prevent="addEvent">
        ...
        <v-text-field v-model="color" type="color" label="color (click to open colour menu)"></v-text-field>
